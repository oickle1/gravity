...
public abstract class AbstractPendulum {
	...
	/*
	 * instance variables - string length, point mass, angular displacement at
	 * t=0, constant for local gravitational field in m/s^2 (e.g., 9.81 on
	 * Earth)
	 */
	 ...
	 * (0<=theta0) inG: gravitational field value to use
	 */
	...
	private boolean validGC(GravityModel val) {
		return (val.getGravitationalField() >= 0);
	}
